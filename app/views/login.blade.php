...
<body>
	...
	<!--<fb:login-button scope="public_profile,email" onlogin="$FacebookService.checkLoginState();">
</fb:login-button>-->
	...
	<a href="{{ $facebook_url }}">Login to Facebook</a>
	<br />
	<a href="{{ $github_url }}">Login to Github</a>
